...
const schemas = {
  ...
  PsychologistAvailabilityDate: {
    type: "object",
    required: ["date", "totalSlots", "availableSlots", "heldSlots", "bookedSlots", "completedSlots", "cancelledSlots", "expiredSlots", "rescheduledSlots"],
    properties: { date: date("2026-06-03"), totalSlots: { type: "integer", minimum: 0, example: 3 }, availableSlots: { type: "integer", minimum: 0, example: 1 }, heldSlots: { type: "integer", minimum: 0, example: 0 }, bookedSlots: { type: "integer", minimum: 0, example: 2 }, completedSlots: { type: "integer", minimum: 0, example: 0 }, cancelledSlots: { type: "integer", minimum: 0, example: 0 }, expiredSlots: { type: "integer", minimum: 0, example: 0 }, rescheduledSlots: { type: "integer", minimum: 0, example: 0 } },
  },
  Booking: {
    type: "object",
...
const schemaExamples: Record<string, Example> = {
  ...
  PsychologistAvailabilityDate: { date: "2026-06-03", totalSlots: 3, availableSlots: 1, heldSlots: 0, bookedSlots: 2, completedSlots: 0, cancelledSlots: 0, expiredSlots: 0, rescheduledSlots: 0 },
